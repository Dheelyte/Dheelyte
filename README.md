...
- [Python Optimization Guide: Make Your Code Run 5X Faster](https://delighto.medium.com/python-optimization-guide-make-your-code-run-5x-faster-d3d77fc76d7a)

- [Django Optimization Guide: Make Your App Run 10X Faster](https://delighto.medium.com/django-optimization-guide-make-your-app-run-10x-faster-8c2f6d49ff27)

- [How to Build, Test and Deploy a URL Shortener with Django](https://delighto.hashnode.dev/build-test-deploy-url-shortener-app-with-django)

- [Unlocking The Power Of Python Comprehension](https://delighto.medium.com/write-better-code-with-python-comprehension-bad8376e44ee)
